...
struct TopMenuRedoButtonChunk: View {
...
struct TopMenuRedoButtonChunk_Previews: PreviewProvider {
    static var previews: some View {
        VStack {
            HStack {
                Spacer()
                TopMenuRedoButtonChunk(mainContainerViewModel: MainContainerViewModel.preview(),
                                               width: 260,
