...
struct TopMenuFlipButtonChunk: View {
...
struct TopMenuFlipButtonChunk_Previews: PreviewProvider {
    static var previews: some View {
        VStack {
            HStack {
                Spacer()
                TopMenuFlipButtonChunk(mainContainerViewModel: MainContainerViewModel.preview(),
