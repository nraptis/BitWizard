...
struct TopMenuUndoButtonChunk: View {
...
struct TopMenuUndoButtonChunk_Previews: PreviewProvider {
    static var previews: some View {
        VStack {
            HStack {
                Spacer()
                TopMenuUndoButtonChunk(mainContainerViewModel: MainContainerViewModel.preview(),
                                               width: 260,
