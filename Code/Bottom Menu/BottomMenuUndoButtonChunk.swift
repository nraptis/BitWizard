//
//  BottomMenuUndoButtonChunk.swift
//  ToolInterface
//
...
struct BottomMenuUndoButtonChunk: View {
    ...
    var body: some View {
        ZStack {
            HStack(spacing: 0) {
                ZStack {
                    Button {
                        mainContainerViewModel.undoIntent()
                    } label: {
...
struct BottomMenuUndoButtonChunk_Previews: PreviewProvider {
    static var previews: some View {
        VStack {
            HStack {
                Spacer()
                BottomMenuUndoButtonChunk(mainContainerViewModel: MainContainerViewModel.preview(),
                                               width: 260,
